...
var (
	addr     = flag.String("addr", "192.168.12.23:8080", "http service address")
...
func signalPeerConnections() {
	...
	attemptSync := func() (tryAgain bool) {
		for i := range peerConnections {
			...
			// Print out the offer in plain text
			log.Printf("Created remote-answer/local-offer:\ntype:\n")
...
func websocketHandler(w http.ResponseWriter, r *http.Request) {
	...
	webrtcConf.SDPSemantics = webrtc.SDPSemanticsUnifiedPlanWithFallback
	...
	for {
		...
		case "answer":
			...
			// Print out the answer in plain text
			log.Printf("Got remote-offer/local-answer:\ntype:\n")
